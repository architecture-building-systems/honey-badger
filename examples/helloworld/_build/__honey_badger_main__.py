...
BADGER_CONFIG = {'description': 'a simple helloworld example assembly with a single component that says helloworld', 'name': 'helloworld', 'id': 'e2ae062a-b547-40ac-8b1a-9447f8d866b2', 'components': [{'subcategory': 'Hello World Sub-Category', 'inputs': [{'nick-name': 'nickname', 'type': 'string', 'name': 'firstname', 'description': 'a name to say hello world to'}], 'description': 'say hello, world :)', 'outputs': [{'nick-name': 'o', 'type': 'string', 'name': 'output', 'description': 'output of the script'}], 'name': 'HelloWorldName', 'id': 'd2fd6e31-1482-4db1-b002-1c7acf291979', 'main-module': 'helloworld', 'category': 'Hello World Category', 'class-name': 'HelloWorldComponent', 'abbreviation': 'hw'}], 'version': '0.1', 'author': 'daren-thomas', 'include-files': ['helloworld.py']}
