...
{
    public class HoneyBadgerComponent : GH_Component
    {
        /// <summary>
        ...
        /// </summary>
        public HoneyBadgerComponent()
          : base("honey-badger-dev", "hbdev",
              "Sample component for testing some dev stuff for honey-badger-runtime",
              "honey-badger", "dev")
        {
        }
        ...
        {
            get { return new Guid("2e2f851d-00eb-42af-a4eb-faa2d1e5c695"); }
        }
    }
}
